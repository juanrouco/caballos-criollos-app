...
import { View, Text, ScrollView, TouchableOpacity, Image, ActivityIndicator, Linking, useWindowDimensions } from 'react-native';
...
export default function NewsDetailScreen({ t, navigation, route }) {
  ...
  return (
    <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 110 }} showsVerticalScrollIndicator={false}>
      ...
      {!!cuerpo && <NewsBody html={cuerpo} t={t} />}
...
// Render del `cuerpo` HTML en un WebView que se autoajusta — la API devuelve
// HTML crudo con imágenes embebidas, así que pintar con texto plano perdería
// formato. El injectedJavaScript postea el scrollHeight al montar y cuando
// terminan de cargar las imágenes.
function NewsBody({ html, t }) {
