...
describe('RankingCatScreen', () => {
  ...
  test('freno: puntaje a la derecha, líneas SBA·RP / Jinete / Propietario', async () => {
    fetchRanking.mockResolvedValue({
      columnas: [
      ...
      filas: [{
        ...
        rider: 'HORACIO DANIEL CASIN', ownet: 'CRIOLLOS DON MIGUEL S.R.L.', points: '19.783',
      }],
    });
    const nav = navStub();
    ...
    expect(getByText('SBA 93182 D  ·  RP 210')).toBeTruthy();        // 1ª línea, sin AF
